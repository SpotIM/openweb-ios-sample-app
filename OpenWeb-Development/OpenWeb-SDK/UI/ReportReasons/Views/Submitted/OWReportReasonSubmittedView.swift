//
<<<<<<< HEAD:OpenWeb-Development/OpenWeb-SDK/UI/ReportReasons/Views/Submitted/OWReportReasonSubmittedView.swift
//  OWReportReasonSubmittedView.swift
//  OpenWebSDK
=======
//  OWSubmittedView.swift
//  SpotImCore
>>>>>>> develop:OpenWeb-Development/OpenWeb-SDK/UI/SubmitedView/Views/OWSubmittedView.swift
//
    ...
    func setupObservers() {
        ...
        OWSharedServicesProvider.shared.themeStyleService()
            ...
            .subscribe(onNext: { [weak self] currentStyle in
                ...
                self.confirmButton.backgroundColor = OWColorPalette.shared.color(type: .brandColor, themeStyle: currentStyle)
            })
            .disposed(by: disposeBag)
