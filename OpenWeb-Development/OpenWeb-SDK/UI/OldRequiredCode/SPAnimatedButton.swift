...
@IBDesignable
class SPAnimatedButton: UIButton {
    ...
    @objc
    func touchUpInside(_ sender: SPAnimatedButton) {
        self.layer.opacity = 1.0
    }
    @objc
    func touchDragExit(_ sender: SPAnimatedButton) {
        self.layer.opacity = 1.0
    }
    @objc
    func touchDragEnter(_ sender: SPAnimatedButton) {
        self.layer.opacity = 0.4
    }
    @objc
    ...
    open func deselect() {
        ...
        selectedImageShape.removeAllAnimations()
