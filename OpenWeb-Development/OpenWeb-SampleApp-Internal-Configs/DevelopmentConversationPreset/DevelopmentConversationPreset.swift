...
public extension DevelopmentConversationPreset {
    ...
    static func developmentPresets() -> [DevelopmentConversationPreset] {
        return [demoSpot()] + [
            DevelopmentConversationPreset(displayName: "Mail Online (MOL)",
                                          conversationDataModel: DevelopmentSDKConversationDataModel(spotId: "sp_jhHPoiRK",
                                                                                                     postId: "13019781")),
            DevelopmentConversationPreset(displayName: "Mail Online Staging",
                                          conversationDataModel: DevelopmentSDKConversationDataModel(spotId: "sp_IAjfVigC",
                                                                                                     postId: "12259677")),
