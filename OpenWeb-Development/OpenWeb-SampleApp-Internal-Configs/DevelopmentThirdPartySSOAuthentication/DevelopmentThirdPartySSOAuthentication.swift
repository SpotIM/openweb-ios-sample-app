//
//  DevelopmentThirdPartySSOAuthentication.swift
...
public struct DevelopmentThirdPartySSOAuthentication {
    public let displayName: String
    public let spotId: String
    public let token: String
    public let provider: OWSSOProvider
}

public extension DevelopmentThirdPartySSOAuthentication {
    static func developmentModels() -> [DevelopmentThirdPartySSOAuthentication] {
        return [
            // swiftlint:disable line_length
            DevelopmentThirdPartySSOAuthentication(displayName: "Fox",
                                                   spotId: "sp_ANQXRpqH",
