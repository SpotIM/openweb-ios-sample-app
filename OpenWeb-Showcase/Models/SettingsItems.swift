...
enum SettingsItems {
    ...
    static let actionColor = SettingsItem(key: "actionColor", defaultValue: CustomizationsViewModel.ActionColorSetting.default)
    static let actionFont = SettingsItem(key: "actionFont", defaultValue: CustomizationsViewModel.ActionFontSetting.default)
    ...
    static let readOnlyMode = SettingsItem(key: "readOnlyMode", defaultValue: ArticleSettingsViewModel.ReadOnlyModeSetting.server)
    ...
    static let preConversationGuidelinesStyle = SettingsItem(key: "preConversationGuidelinesStyle", defaultValue: ScreenSettingsViewModel.GuidelinesStyleSetting.regular)
    static let preConversationQuestionsStyle = SettingsItem(key: "preConversationQuestionsStyle", defaultValue: ScreenSettingsViewModel.QuestionsStyleSetting.regular)
    ...
    static let conversationGuidelinesStyle = SettingsItem(key: "conversationGuidelinesStyle", defaultValue: ScreenSettingsViewModel.GuidelinesStyleSetting.regular)
    static let conversationQuestionsStyle = SettingsItem(key: "conversationQuestionsStyle", defaultValue: ScreenSettingsViewModel.QuestionsStyleSetting.regular)
