    ...
    static func addElementsCustomization() {
        ...
        case 2:
            customizations.customizedTheme = OWTheme(
                ...
                tertiaryTextColor: OWColor(lightColor: .brown, darkColor: .green),
                primaryBackgroundColor: OWColor(lightColor: .blue, darkColor: .green),
                secondaryBackgroundColor: OWColor(lightColor: .systemPink, darkColor: .orange),
                tertiaryBackgroundColor: OWColor(lightColor: .brown, darkColor: .cyan),
