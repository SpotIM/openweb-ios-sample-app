...
xcodebuild archive -workspace "${WORKSPACE}" -scheme "${TARGET_NAME}" -destination="iOS" -sdk iphoneos        SKIP_INSTALL=NO BUILD_LIBRARIES_FOR_DISTRIBUTION=YES -archivePath "${BUILD_DIR}/Release-iphoneos"
