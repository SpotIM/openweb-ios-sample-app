//
//  OWCommentThreadExpandCell.swift
//  SpotImCore
//
...
class OWCommentThreadExpandCell: UITableViewCell {
    ...
    fileprivate var viewModel: OWCommentThreadExpandCellViewModeling!
...
fileprivate extension OWCommentThreadExpandCell {
    func setupUI() {
