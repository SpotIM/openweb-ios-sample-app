//
//  SPCommentStatusIndicationView.swift
//  SpotImCore
//
...
class SPCommentStatusIndicationView: UIView {
    struct Metrics {
    ...
    private let iconImageView: UIImageView = {
        return UIImageView()
            .image(UIImage(spNamed: "oldPendingIcon")!)
    }()
    ...
    fileprivate var viewModel: SPCommentStatusIndicationViewModeling!
    ...
    func configure(with viewModel: SPCommentStatusIndicationViewModeling) {
...
fileprivate extension SPCommentStatusIndicationView {
    func setupObservers() {
