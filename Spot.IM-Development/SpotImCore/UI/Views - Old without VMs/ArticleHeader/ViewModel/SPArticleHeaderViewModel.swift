//
//  SPArticleHeaderViewModel.swift
//  SpotImCore
//
...
protocol SPArticleHeaderViewModelingInputs {
    var tap: PublishSubject<Void> { get }
}

protocol SPArticleHeaderViewModelingOutputs {
...
protocol SPArticleHeaderViewModeling {
    var inputs: SPArticleHeaderViewModelingInputs { get }
    var outputs: SPArticleHeaderViewModelingOutputs { get }
}

class SPArticleHeaderViewModel: SPArticleHeaderViewModeling,
                                SPArticleHeaderViewModelingInputs,
                                SPArticleHeaderViewModelingOutputs {

    var inputs: SPArticleHeaderViewModelingInputs { return self }
    var outputs: SPArticleHeaderViewModelingOutputs { return self }
