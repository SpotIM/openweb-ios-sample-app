...
//        commentLabelColor = UIColor.color(with: colorString) ?? .clear
    ...
    func setLabel(iconName: String?, iconType: String?, rgbColor: String?, labelText: String?) {
        if let iconName = iconName, let iconType = iconType, let rgbColor = rgbColor, let labelText = labelText {
            ...
            self.commentLabelColor = UIColor.color(with: hexColor) ?? .clear
...
//        label.textColor = .red //commentLabelColor
//        label.text = labelText
        label.layout {
