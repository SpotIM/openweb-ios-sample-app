...
protocol OWAuthorizationRecoveryServicingOldAPI {
    func recoverFromAuthorizationError(userId: String) -> Observable<Void>
}
class OWAuthorizationRecoveryServiceOldAPI: OWAuthorizationRecoveryServicingOldAPI {
...
fileprivate extension OWAuthorizationRecoveryServiceOldAPI {
