...
public enum OWPreConversationStyle {
    public struct Metrics {
        ...
        public static let defaultCollapsableTextLineLimit: Int = 4
    }

    case regular(numberOfComments: Int = Metrics.defaultRegularNumberOfComments, collapsableTextLineLimit: Int = Metrics.defaultCollapsableTextLineLimit)
    case compact(collapsableTextLineLimit: Int = Metrics.defaultCollapsableTextLineLimit)
